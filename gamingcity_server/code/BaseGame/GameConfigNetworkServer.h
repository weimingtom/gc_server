...
class GameConfigNetworkServer : public TSingleton < GameConfigNetworkServer >
{
public:
	GameConfigNetworkServer();
    ...
    std::shared_ptr<NetworkSession> get_cfg_session()    { return cfg_session_;}
protected:
private:
