...
//头像大小
#define FACE_CX						128									//头像宽度
#define FACE_CY						128									//头像高度

//长度定义
#define LEN_LESS_ACCOUNTS			5									//最短帐号
#define LEN_LESS_NICKNAME			5									//最短昵称
...
#define LEN_OSVERSION_ID			128									//系统版本长度
#define LEN_CPUID_ID				64									//CPUID长度
#define LEN_DISKSERIAL_ID			64									//硬盘序列号长度
#define LEN_INSTALLER_ID			128									//安装包名称长度
#define LEN_SCREEN					12									//屏幕分辨率长度
#define LEN_CHANNEL_ID			128										//安装包渠道名称长度
