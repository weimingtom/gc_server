...
public:
	...
	static LONGLONG GetFishEffect(CBullet* pBullet, CFish* pFish, std::list<MyObject*>& list, bool bPretreating = false);

	static const char* ReplaceString(WORD wChairID, std::string& str);
};
